import{h as q,k as M,K as v,l as b,m as t,_ as s,aF as C,r as z,u as D,c as T,n as j,O,j as U,a as g,e as K,a4 as A,a3 as w}from"./index.js";function X(r){return q("MuiLinearProgress",r)}M("MuiLinearProgress",["root","colorPrimary","colorSecondary","determinate","indeterminate","buffer","query","dashed","dashedColorPrimary","dashedColorSecondary","bar","barColorPrimary","barColorSecondary","bar1Indeterminate","bar1Determinate","bar1Buffer","bar2Indeterminate","bar2Buffer"]);const F=["className","color","value","valueBuffer","variant"];let l=r=>r,k,x,L,B,I,_;const h=4,S=v(k||(k=l`
  0% {
    left: -35%;
    right: 100%;
  }
